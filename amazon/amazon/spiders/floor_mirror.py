...
class FloorMirrorSpider(scrapy.Spider):
    name = 'floor_mirror'
    start_urls = ['https://www.amazon.in/s?k=floor+mirror&page=1']
    headers = {
        'Accept': '*/*',
    ...
    def parse(self, response):
        ...
        # end here
        if FloorMirrorSpider.page_number == 1:
        ...
        if next_page != '':
            FloorMirrorSpider.page_number += 1
